...
public:
    ...
    RailwaySystem(int numTracks, int trainsPerTrack, int trackLength) : totalLength(trackLength), segmentLength(10), shortStationLength(2), simulationActive(true) {
        segments.resize(numTracks); positions.resize(numTracks);
